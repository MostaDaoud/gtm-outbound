...
> Ported from the Claude Code subagent `linkedin-lab-miner`.
> >
...
```bash
python /absolute/path/to/linkedin-lab/scripts/linkedin_lab.py extract --find "lesson title" --from 04:00 --to 08:00
```
