"""Persistent, cross-platform configuration for copy-lab.
...
CONFIG_ENV_VAR = "COPY_LAB_CONFIG"
CORPUS_ENV_VAR = "COPY_LAB_CORPUS"
DATA_ENV_VAR = "COPY_LAB_DATA"
COURSE_MAP_ENV_VAR = "COPY_LAB_COURSE_MAP"
SOURCE_CATALOG_ENV_VAR = "COPY_LAB_SOURCE_CATALOG"
...
def default_config_path() -> Path:
    """Return the per-user copy-lab configuration path.
    ...
    return Path.home() / ".agents" / "copy-lab" / "config.json"
...
def resolve_data_dir(
    ...
    *,
    ...
    ``.copy-lab-data`` directory. Callers that need a generated artifact may
        ...
        if target is None:
            ...
            if located is None:
                try:
                    ...
                    located = None
            target = located.parent / ".copy-lab-data" if located else BUNDLED_ASSETS
