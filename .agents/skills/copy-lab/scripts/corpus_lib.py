"""Shared helpers for reading the copy-lab transcript corpus.
...
from copy_lab_config import resolve_corpus, resolve_course_map
...
def load_course_map() -> dict[str, str]:
    ...
    Resolution is handled by :mod:`copy_lab_config`. Keys beginning with ``_``
