#!/usr/bin/env python3
"""Validate a built Copy Lab Obsidian vault."""
...
REQUIRED = [
    ...
    "Dashboards/Copy Lab Workflow.canvas",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print("OK: Copy Lab vault is valid" if result["ok"] else "FAIL: Copy Lab vault is invalid")
